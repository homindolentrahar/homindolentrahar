                  ...
                  <div className="flex flex-col">
                    ...
                    <div className="flex flex-row flex-wrap gap-2 mt-4">
                      {[item.data.type, item.data.workScheme].map((item) => (
                        <div className="text-sm font-medium px-3 py-1 rounded-md bg-gray-200/75 dark:bg-gray-800 text-gray-950 dark:text-white">
                          {item}
                        </div>
                      ))}
                    </div>
        ...
        {selectedExp && (
          <div className="flex flex-col gap-0">
            <div className="flex flex-col items-start">
              <h1 className="text-xl font-semibold text-gray-950 dark:text-white leading-none">
              ...
              <div className="flex flex-row gap-1 font-normal text-sm text-gray-500 dark:text-gray-400 mt-2">
